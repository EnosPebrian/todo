...
export const Register = ({ users, setUser, fetchData }) => {
...
export const RegisterFormik = ({ users, setUser, fetchData }) => {
  const nav = useNavigate();
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object().shape({
      fullname: Yup.string()
        .required("isi woi")
        .min(5, "min 5 bos")
        .max(10, "eee kelebihan")
        .minSymbols(1, "kurang 1 symbol"),
      email: Yup.string().email("masukan email dengan benar"),
    }),
  });
