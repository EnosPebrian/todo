...
import login_img from "../img/photos-login.png";
import { useNavigate } from "react-router-dom";

function handleLogin(username, password, array) {
      ...
      >
        ...
        <main className="form-signin w-100 m-auto">
          <form>
            ...
            <button
              onClick={() =>
                handleLogin(getVal("floatingInput"), getVal("floatingPassword"),arrayofuser)
              }
